        ...
        <Route
          ...
          element={
            <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div className="relative h-64 md:h-80">
                  ...
                  <div className="absolute inset-0 flex items-center px-6 md:px-12">
                    <div className="max-w-2xl">
                      <h1 className="text-3xl md:text-4xl font-bold text-white mb-4">Eco-Friendly Paper Water Bottles</h1>
                      <p className="text-green-100 text-lg md:text-xl mb-6">Sustainable hydration for a better tomorrow. 100% biodegradable and compostable.</p>
                      <Link to="/" className="inline-block bg-white text-green-700 px-6 py-3 rounded-lg font-medium hover:bg-green-50 transition-colors">
                        Shop Now
                      </Link>
                    </div>
                  </div>
              ...
              {/* Size Filter */}
              <div className="mb-8">
                <h2 className="text-lg font-medium text-gray-900 mb-3">Filter by Size (ml)</h2>
                <div className="flex flex-wrap gap-2">
                  <button
                    onClick={() => setSizeFilter('all')}
                    className={`px-4 py-2 rounded-full text-sm font-medium ${sizeFilter === 'all' ? 'bg-green-600 text-white' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'}`}
                  >
                    All Sizes
                  </button>
                  <button
                    onClick={() => setSizeFilter('500')}
                    className={`px-4 py-2 rounded-full text-sm font-medium ${sizeFilter === '500' ? 'bg-green-600 text-white' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'}`}
                  >
                    500ml
                  </button>
                  <button
                    onClick={() => setSizeFilter('750')}
                    className={`px-4 py-2 rounded-full text-sm font-medium ${sizeFilter === '750' ? 'bg-green-600 text-white' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'}`}
                  >
                    750ml
                  </button>
                </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                    {filteredProducts.map((product) => (
                      <ProductCard
                        ...
                        onMessageSeller={() => handleMessageSeller(product)}
                      />
                    ))}
                  </div>
                ) : (
